...
async function carregarConteudo() {
  ...
  document.getElementById("paginaDesc").textContent =
    `Todos os ${secaoValida === "lancamentos" ? "lançamentos" : "melhores"} de ${tipoValido === "filmes" ? "filmes" : "séries"}.`;

  try {
    const endpoint =
      secaoValida === "melhores"
        ? `/${tipoValido}/melhores`
